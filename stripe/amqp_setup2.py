...
# Added:  If we wanted to connect to a broker on a different machine we'd simply specify its name or IP address here.
...
############   Error queue   #############
#delcare payment queue 
queue_name = 'payment'
channel.queue_declare(queue=queue_name, durable=True) 
    # 'durable' makes the queue survive broker restarts

#bind Error queue
channel.queue_bind(exchange=exchangename, queue=queue_name, routing_key='pay_successful') 
